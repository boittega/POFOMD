...
BubbleTreeStyles.Cofog1 = {
    '2015-05-01': { icon: 'may.svg', color: '#259b24', shortLabel: 'Maio' },
    '2015-04-01': { icon: 'april.svg', color: '#9c27b0', shortLabel: 'Abril' },
    '2015-03-01': { icon: 'march.svg', color: '#C75746', shortLabel: 'Mar&ccedil;o' },
    '2015-02-01': { icon: 'february.svg', color: '#0AB971', shortLabel: 'Fevereiro' },
    '2015-01-01': { icon: 'january.svg', color: '#4E6D00', shortLabel: 'Janeiro' }
};

//esse é no bubble.html
BubbleTreeStyles.Cofog2 = {
    'name': {
        'defesa': { icon: 'defence.svg' },
        'servi-os-p-blicos-gerais': { icon: 'social-systems.svg' },
        'sa-de': { icon: 'health.svg'},
        'recrea-o-cultura-e-religi-o': { icon: 'culture.svg'},
        'educação': { icon: 'education.svg' }
    }
};

BubbleTreeStyles.Cofog3 = {
    '01.1': { icon: 'legislative.svg', shortLabel: '<a id="Marco" href="#" onclick="$(function() {event.preventDefault(); $(\'#dialog\').dialog(\'open\');});">Órgãos executivos e legislativos, administração financeira e fiscal, assuntos externos</a>' },
    '01.2': { icon: 'aid.svg' },
