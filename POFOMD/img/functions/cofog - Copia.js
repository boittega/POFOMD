...
BubbleTreeStyles.Cofog2 = {
    ...
    'Defesa': { icon: 'defence.svg', color: '#0AB971' },
    '03': { icon: 'order-safety.svg', color: '#EC2406' },
    'Serviços públicos gerais': { icon: 'social-systems.svg', color: '#790586' },
    '05': { icon: 'environment.svg', color: '#2A3A03' },
    '06': { icon: 'our-streets.svg', color: '#D33673' },
    'Saúde': { icon: 'health.svg', color: '#4E6D00' },
    'Recreação cultura e religião': { icon: 'culture.svg', color: '#938626' },
